  ...
  return (
    <FooterContainer>
      ...
      <SocialLinks>
        ...
        <li>
          <a href="https://www.linkedin.com/in/vivianezzt/" target="_blank" rel="noopener noreferrer">
            <img src="/assets/linkedin.png" alt="LinkedIn" />
          </a>
        </li>
      </SocialLinks>
      <p>
        A efood é uma plataforma para divulgação de estabelecimentos. A responsabilidade pela entrega e qualidade dos
        produtos é do estabelecimento contratado.
      </p>
    </FooterContainer>
  );
};
